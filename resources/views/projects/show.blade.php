...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-800 text-gray-100">
        ...
        <section id="project-details" class="py-10 bg-gray-800">
            <div class="container mx-auto px-6">
                ...
                <div class="mx-auto text-center my-3">
                    <a href="{{ route('projects.index') }}" class="text-lg bg-gray-600 text-white p-2 rounded-lg hover:bg-gray-700">Back to Projects</a>
                </div>
            </div>
        </section>
